...
use Wlalele\Bundle\CatalogBundle\Entity\Document;
use Wlalele\Bundle\CatalogBundle\Form\DocumentType;
...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WlaleleCatalogBundle:Document')->findAll();
     ...
     * @Method("POST")
     * @Template("WlaleleCatalogBundle:Document:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WlaleleCatalogBundle:Document')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WlaleleCatalogBundle:Document:edit.html.twig")
     */
